    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='car_Safety.Car')),
            ],
        ),
        migrations.CreateModel(
            name='Recall',
            fields=[
                ...
                ('car', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='car_Safety.Car')),
            ],
        ),
    ]
